...
<footer style="margin-top: auto; font-family: 'Inter', sans-serif;">
    ...
    <div style="background-color: var(--azul-uady); color: white; padding: 40px 50px;">
        ...
        <div style="max-width: 1300px; margin: 30px auto 0 auto; padding-top: 25px; border-top: 1px solid rgba(255, 255, 255, 0.2); display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 20px;">
            ...
            <div style="flex: 1; text-align: center; font-size: 12px; color: #e2e8f0; max-width: 800px; margin: 0 auto;">
